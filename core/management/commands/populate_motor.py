    ...
    def handle(self, *args, **kwargs):
        ...
        for season_name, season_id in season_ids.items():
            ...
            for item in data:
                ...
                # Keyed on idEvent alone so a reschedule (date_time change)
            ...
            for item in data:
                ...
                for competition in Competition.objects.filter(league=season_name):
                    ...
                    # Keyed on idEvent alone so a reschedule (date_time
                    # change) updates the existing row instead of creating a
                    # duplicate.
